...
request = require('request'),
  ...
  admins = ["847456852853391381", "828874908263120936", "529165692055060525"],
  config = {
    "867052424668643368": 1500,
    "867053550781333504": 1250,
    "867052430818934794": 1000,
    "867052431938813974": 600,
    "867052451546267648": 500,
    "867052456390950913": 250,
    "867052457200320512": 150,
    "808670641271734303": 100,
  }
...
client.on('message', async (message) => {
  ...
  if (command === "buy") {
    message.channel.send(new Discord.MessageEmbed()
      .setDescription(`$25 for Lifetime, DM **ilovedonkey#0911** for more info`)
      .setColor("PURPLE")
      .setFooter(message.guild.name, message.guild.iconURL({
        dynamic: true
      }))
